...
export function MainComposer({ onSubmit, placeholder = "Let's build an enterprise solution that..." }) {
        ...
        <div className="flex items-center justify-between px-2 pb-1">
          <div className="flex items-center gap-4">
            <Button
              ...
              variant="ghost"
              size="icon"
              className="h-8 w-8 rounded-full bg-white/5 text-muted-foreground hover:text-foreground"
            >
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="h-8 px-0 rounded-full gap-2 hover:bg-transparent text-muted-foreground hover:text-foreground border-none"
                >
